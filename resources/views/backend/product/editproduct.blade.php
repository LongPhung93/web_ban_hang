                        ...
                        <div class="row" style="margin-bottom:40px">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="text" name="sku" disabled class="form-control" value="SP01">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button class="btn btn-danger" onclick="window.history.go(-1);return false;" type="reset">Huỷ bỏ</button>
                                </div>
                            </div>
