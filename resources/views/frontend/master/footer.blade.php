    ...
    <div class="container">
        <div class="row row-pb-md">
            <div class="col-md-3 colorlib-widget">
                <h4>Giới thiệu</h4>
                <p>CODEGYM STORE cửa hàng kinh doanh quần áo luôn mang tới sự hài lòng cho khách hàng về chất
                    lượng sản phẩm, quần
            ...
            <div class="col-md-4">
                ...
                <ul class="colorlib-footer-links">
                    <li>Số 23 lô TT01 - Khu đô thị HD Mon City - Nguyễn Cơ Thạch - Nam Từ Liêm - Hà Nôi </li>
                    <li><a href="tel://1234567920">0988 550 553</a></li>
                    <li><a href="mailto:info@yoursite.com">info@codegym.vn</a></li>
                    <li><a href="#">http://codegym.vn</a></li>
                </ul>
            </div>
        </div>
    </div>
